...
namespace AppSemCamadas.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            // incluiu as informacoes do fornecedor, pois ele entende a relacao de produtos e fornecedor
        ...
        {
            // ViewData componente de tranposrte controller > view
            ViewData["FornecedorId"] = new SelectList(_context.Fornecedores, "Id", "Nome"); // gera uma lista dos fornecedores, para esoclher dentre eles
            return View();
        }
